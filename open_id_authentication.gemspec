...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/open_id_authentication/version.rb", mod) }::OpenIdAuthentication::Version::VERSION
  else
    require_relative "lib/open_id_authentication/version"
    OpenIdAuthentication::Version::VERSION
  end

Gem::Specification.new do |spec|
  spec.name = "open_id_authentication"
  spec.version = gem_version
  spec.authors = ["bitsweat", "david", "Geoffrey Grosenbach", "Phil R", "Peat Bakke", "Joshua Peek", "patricksrobertson", "Tom Hughes", "grosser", "Michael Grosser", "Annibelle Boling", "Peter H. Boling", "Aboling0"]
  spec.email = ["floss@galtzo.com"]

  spec.summary = "💎 Provides a thin wrapper around the excellent rack-openid2 gem."
  spec.description = "💎 Provides a thin wrapper around the excellent rack-openid2 gem."
  spec.homepage = "https://github.com/pboling/open_id_authentication"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://open-id-authentication.galtzo.com"
  ...
  spec.add_development_dependency("kettle-dev", "~> 2.2", ">= 2.2.13")     # ruby >= 2.7.0
  ...
  spec.add_development_dependency("kettle-test", "~> 2.0", ">= 2.0.5")             # ruby >= 2.7.0
  ...
  # The 'git' gem is optional; open_id_authentication falls back to shelling out to `git` if it is not present.
