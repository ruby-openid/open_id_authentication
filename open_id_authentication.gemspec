...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/ruby-openid/open_id_authentication"
  spec.licenses = ["MIT"]
  ...
  spec.add_development_dependency("kettle-dev", "~> 2.2", ">= 2.2.25")     # ruby >= 2.7.0
  ...
  spec.add_development_dependency("kettle-test", "~> 2.0", ">= 2.0.9")             # ruby >= 2.7.0
