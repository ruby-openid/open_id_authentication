# kettle-jem:freeze
# To retain chunks of comments & code during open_id_authentication templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# open_id_authentication will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
