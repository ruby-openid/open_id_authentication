...
- One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/open_id_authentication/my_class.rb` -> `spec/open_id_authentication/my_class_spec.rb`.
...
[🧪build]: https://github.com/ruby-openid/open_id_authentication/actions
